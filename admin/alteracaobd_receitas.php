...
<html lang="en">
  ...
  <body>
    <?php 
        include "conect.php";
        $id =$_GET['id'] ?? '';
        $sql ="SELECT * FROM cadastro_receitas WHERE cod_cliente = $id";
    ...
    <div class= "container"> 
        <div class= "row">
            ...
            <form action="alteracao_receitas.php" method="POST">  
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nomeReceita" value="<?php echo $linha['nomeReceita']; ?>">
                ...
                <textarea class="form-control" name="receita" value="<?php echo $linha['receita']; 
                ?>"> </textarea>
                    </div>
